...
public class JavaSourceViewerConfiguration extends SourceViewerConfiguration {
    ...
    public IContentAssistant getContentAssistant(ISourceViewer sourceViewer) {
		...
		assistant.setContextInformationPopupBackground(JavaEditorExamplePlugin.getDefault().getJavaColorProvider().getColor(new RGB(255, 255, 255)));
    ...
    public IPresentationReconciler getPresentationReconciler(ISourceViewer sourceViewer) {
		...
		dr= new DefaultDamagerRepairer(new SingleTokenScanner(new TextAttribute(provider.getColor(PreferencesInitializer.IDC_COMMENT))));
