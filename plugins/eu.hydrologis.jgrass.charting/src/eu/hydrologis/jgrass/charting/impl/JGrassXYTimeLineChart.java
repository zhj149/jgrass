 ...
 */
public class JGrassXYTimeLineChart extends JGrassChart implements ActionListener {
    ...
    private Constructor<RegularTimePeriod> constructor;
    ...
    public JGrassXYTimeLineChart( List<String> chartTitles, List<double[][]> chartValues,
            Class< ? > timeClass ) {
        try {
            chartSeries = new TimeSeries[chartValues.size()];
    ...
    public JGrassXYTimeLineChart( String[] chartTitles, double[][][] chartValues,
            Class< ? > timeClass ) {
        try {
    ...
    public void toggleFilledShapeDisplay( boolean showShapes, boolean fillShapes, boolean plotLines ) {
        if (thePlot != null) {
            // renderer.setPlotLines(plotLines);
            ((XYLineAndShapeRenderer) renderer).setBaseShapesVisible(showShapes);
            ((XYLineAndShapeRenderer) renderer).setBaseShapesFilled(fillShapes);
