...
public class FileOpenChooserFieldRenderer extends InputFieldRenderer {

    private Text text;
    private Button button;
    private Composite valueComponent;

    public FileOpenChooserFieldRenderer( DataField df ) {
        super(df);
    }
        ...
        if (valueComponent == null) {
            ...
            button.addListener(SWT.Selection, new Listener(){
                public void handleEvent( Event event ) {
                    ...
                    f
                            .setFilterExtensions(((eu.hydrologis.jgrass.uibuilder.fields.FileOpenChooserField) getDataField())
