...
public class FileChooserFieldRenderer extends InputFieldRenderer {

    private Text text;
    private Button button;
    private Composite valueComponent;

    public FileChooserFieldRenderer( DataField df ) {
        super(df);
    }
        ...
        if (valueComponent == null) {
            ...
            button.addListener(SWT.Selection, new Listener(){
                public void handleEvent( Event event ) {
                    ...
                    f
                            .setFilterExtensions(((eu.hydrologis.jgrass.uibuilder.fields.FileChooserField) getDataField())
