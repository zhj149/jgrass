...
/**
 * Represents a data field for a string value.
 * 
...
public class StringField extends InputField {
	...
	public StringField(Node xmlNode, String name, String desc, String repr, boolean required, String defaultValue, int order) {
