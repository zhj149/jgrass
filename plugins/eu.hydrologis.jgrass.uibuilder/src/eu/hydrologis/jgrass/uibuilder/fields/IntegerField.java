...
/**
 * Represents a data field for an integer value.
 * 
...
public class IntegerField extends InputField {
	...
	public IntegerField(Node xmlNode, String name, String desc, String repr, boolean required, String defaultValue, int order) {
	...
	public void setValue(Object value) {
		try {
			...
			throw new IllegalArgumentException("The new value should be an integer.");
		}
	}
}
