...
/**
 * Represents a data field for a command.
 * 
 * @author Patrick Ohnewein
 */
public class CommandField extends DataField {
	
	public CommandField(Node xmlNode, String name, String desc, String repr, boolean required, String defaultValue, int order) {
