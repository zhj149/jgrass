...
/**
 * Represents a data field for a file path.
 * 
 * @author Andrea Antonello - www.hydrologis.com
 */
public class FileOpenChooserField extends InputField {

    private String value;

    private ArrayList<String> acceptedExtensions;

    public FileOpenChooserField( Node xmlNode, String name, String desc, String repr, boolean required,
