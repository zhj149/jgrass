...
/**
 * Represents a data field for a multiple choice option.
 * 
 * @author Patrick Ohnewein
 */
public class MultiOptionField extends GenericOptionField {
	
	public MultiOptionField(Node xmlNode, String name, String desc, String repr, boolean required, String defaultValue, int order) {
