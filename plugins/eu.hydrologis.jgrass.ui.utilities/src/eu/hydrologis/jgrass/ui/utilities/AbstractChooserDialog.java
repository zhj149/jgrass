...
public abstract class AbstractChooserDialog extends SelectionAdapter {
    ...
    private final String CATALOGTYPE = "catalogtype"; //$NON-NLS-1$
    ...
    protected void makeCheckPanel() {
        ...
        visibleLayersLabel.setToolTipText(Messages
                .getString("AbstractChooserDialog.visualizevisiblelayers")); //$NON-NLS-1$
        ...
        catalogLayersLabel.setToolTipText(Messages
                .getString("AbstractChooserDialog.visualizecatalog")); //$NON-NLS-1$
