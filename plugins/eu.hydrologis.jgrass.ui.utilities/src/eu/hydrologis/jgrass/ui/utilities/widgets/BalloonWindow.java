package eu.hydrologis.jgrass.ui.utilities.widgets;
...
public class BalloonWindow {
    ...
    private BalloonWindow( Display display, Shell parent, final int style ) {
        ...
        this.shell = (display != null) ? new Shell(display, SWT.NO_TRIM | shellStyle) : new Shell(
                parent, SWT.NO_TRIM | shellStyle);
    ...
    public void prepareForOpen() {
        ...
        if (showTitle) {
            ...
            if (systemControlsBar == null && (style & SWT.CLOSE) != 0) {
                ...
                // shell.getBackground();
                Color closeFG = shell.getDisplay().getSystemColor(SWT.COLOR_WIDGET_FOREGROUND), closeBG = shell
        ...
        final Point shellSize = (anchor == SWT.NONE) ? new Point(contentsSize.x + marginLeft
                + marginRight, contentsSize.y + marginTop + marginBottom) : new Point(
                contentsSize.x + marginLeft + marginRight, contentsSize.y + marginTop
                        + marginBottom + 20);
    ...
    private static int[] createOutline( Point size, int anchor, boolean outer ) {
        ...
        case SWT.RIGHT | SWT.BOTTOM:
            return new int[]{
                    ...
                    w - 1, h - 26, w - 2, h - 26, w - 2, h - 24, w - 3,
                    h - 24,
                    w - 3,
                    h - 23,
                    w - 4,
                    ...
                    w - 17 - o, h - 2, w - 17 - o, h - 3, w - 18 - o, h - 3, w - 18 - o, h - 4,
                    w - 19 - o, h - 4, w - 19 - o, h - 5, w - 20 - o, h - 5, w - 20 - o, h - 6,
                    w - 21 - o, h - 6, w - 21 - o, h - 7, w - 22 - o, h - 7, w - 22 - o, h - 8,
                    w - 23 - o, h - 8, w - 23 - o, h - 9, w - 24 - o, h - 9, w - 24 - o, h - 10,
                    w - 25 - o, h - 10, w - 25 - o, h - 11, w - 26 - o, h - 11, w - 26 - o, h - 12,
                    w - 27 - o, h - 12, w - 27 - o, h - 13, w - 28 - o, h - 13, w - 28 - o, h - 14,
                    w - 29 - o, h - 14, w - 29 - o, h - 15, w - 30 - o, h - 15, w - 30 - o, h - 16,
                    w - 31 - o, h - 16, w - 31 - o, h - 17, w - 32 - o, h - 17, w - 32 - o, h - 18,
                    w - 33 - o, h - 18, w - 33 - o, h - 19, w - 34 - o, h - 19, w - 34 - o, h - 20,
                    w - 35 - o, h - 20, w - 35 - o, h - 21,
                    // bottom left
                    5, h - 21, 5, h - 22, 3, h - 22, 3, h - 23, 2, h - 23, 2, h - 24, 1, h - 24, 1,
                    h - 26, 0, h - 26,
                    // left and top left
        ...
        case SWT.LEFT | SWT.BOTTOM:
            return new int[]{
                    ...
                    5,
                    // right and bottom right
                    w - 1, h - 26, w - 2, h - 26, w - 2, h - 24, w - 3, h - 24, w - 3,
                    h - 23,
                    w - 4,
                    h - 23,
                    w - 4,
                    ...
                    h - 21,
                    // bottom with anchor
                    34 + o, h - 21, 34 + o, h - 20, 33 + o, h - 20, 33 + o, h - 19, 32 + o, h - 19,
                    32 + o, h - 18, 31 + o, h - 18, 31 + o, h - 17, 30 + o, h - 17, 30 + o, h - 16,
                    29 + o, h - 16, 29 + o, h - 15, 28 + o, h - 15, 28 + o, h - 14, 27 + o, h - 14,
                    27 + o, h - 13, 26 + o, h - 13, 26 + o, h - 12, 25 + o, h - 12, 25 + o, h - 11,
                    24 + o, h - 11, 24 + o, h - 10, 23 + o, h - 10, 23 + o, h - 9, 22 + o, h - 9,
                    22 + o, h - 8, 21 + o, h - 8, 21 + o, h - 7, 20 + o, h - 7, 20 + o, h - 6,
                    19 + o, h - 6, 19 + o, h - 5, 18 + o, h - 5, 18 + o, h - 4, 17 + o, h - 4,
                    17 + o, h - 3, 16 + o, h - 3, 16 + o, h - 2, 15 + o, h - 2, 15, h - 1, 15,
                    h - 21,
                    // bottom left
                    5, h - 21, 5, h - 22, 3, h - 22, 3, h - 23, 2, h - 23, 2, h - 24, 1, h - 24, 1,
                    h - 26, 0, h - 26,
        ...
        case SWT.RIGHT | SWT.TOP:
            return new int[]{
                    // top with anchor
                    5, 20, w - 35 - o, 20, w - 35 - o, 19, w - 34 - o, 19, w - 34 - o, 18,
                    w - 33 - o, 18, w - 33 - o, 17, w - 32 - o, 17, w - 32 - o, 16, w - 31 - o, 16,
                    w - 31 - o, 15, w - 30 - o, 15, w - 30 - o, 14, w - 29 - o, 14, w - 29 - o, 13,
                    w - 28 - o, 13, w - 28 - o, 12, w - 27 - o, 12, w - 27 - o, 11, w - 26 - o, 11,
                    w - 26 - o, 10, w - 25 - o, 10, w - 25 - o, 9, w - 24 - o, 9, w - 24 - o, 8,
                    w - 23 - o, 8, w - 23 - o, 7, w - 22 - o, 7, w - 22 - o, 6, w - 21 - o, 6,
                    w - 21 - o, 5, w - 20 - o, 5, w - 20 - o, 4, w - 19 - o, 4, w - 19 - o, 3,
                    w - 18 - o, 3, w - 18 - o, 2, w - 17 - o, 2, w - 17 - o, 1, w - 16 - o, 1,
                    w - 16 - o, 0, w - 16, 0,
                    w - 16,
                    20,
                    // top and top right
                    w - 6, 20, w - 6, 21, w - 4, 21, w - 4, 22, w - 3, 22, w - 3, 23, w - 2, 23,
                    w - 2, 25, w - 1,
                    25,
                    // right and bottom right
                    w - 1, h - 6, w - 2, h - 6, w - 2, h - 4, w - 3, h - 4, w - 3, h - 3, w - 4,
                    h - 3, w - 4, h - 2, w - 6, h - 2, w - 6, h - 1,
                    // bottom and bottom left
                    5, h - 1, 5, h - 2, 3, h - 2, 3, h - 3, 2, h - 3, 2, h - 4, 1, h - 4, 1, h - 6,
                    0, h - 6,
                    // left and top left
        ...
        case SWT.LEFT | SWT.TOP:
            return new int[]{
                    // top with anchor
                    5, 20, 15, 20, 15, 0, 15 + o, 0, 16 + o, 1, 16 + o, 2, 17 + o, 2, 17 + o, 3,
                    18 + o, 3, 18 + o, 4, 19 + o, 4, 19 + o, 5, 20 + o, 5, 20 + o, 6, 21 + o, 6,
                    21 + o, 7, 22 + o, 7, 22 + o, 8, 23 + o, 8, 23 + o, 9, 24 + o, 9, 24 + o, 10,
                    25 + o, 10, 25 + o, 11, 26 + o, 11, 26 + o, 12, 27 + o, 12, 27 + o, 13, 28 + o,
                    13, 28 + o, 14, 29 + o, 14, 29 + o, 15, 30 + o, 15, 30 + o, 16, 31 + o, 16,
                    31 + o, 17, 32 + o, 17, 32 + o, 18, 33 + o, 18, 33 + o, 19, 34 + o,
                    19,
                    34 + o,
                    20,
                    // top and top right
        ...
        default:
            return new int[]{
                    // top and top right
                    5, 0, w - 6, 0, w - 6, 1, w - 4, 1, w - 4, 2, w - 3, 2, w - 3, 3, w - 2, 3,
                    w - 2, 5, w - 1,
                    5,
                    // right and bottom right
                    w - 1, h - 6, w - 2, h - 6, w - 2, h - 4, w - 3, h - 4, w - 3, h - 3, w - 4,
    ...
    private static final Image createCloseImage( Display display, Color bg, Color fg ) {
        ...
        /*
         * gc.drawLine(1, 0, size-2, 0); gc.drawLine(1, size-1, size-2, size-1); gc.drawLine(0, 1,
         * 0, size-2); gc.drawLine(size-1, 1, size-1, size-2);
         */
        gc.dispose();
        return image;
    }
