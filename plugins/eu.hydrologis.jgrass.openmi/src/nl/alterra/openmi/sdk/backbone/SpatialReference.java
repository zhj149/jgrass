...
/**
 * The SpatialReference class defines a spatial reference.
 */
public class SpatialReference extends BackboneObject implements ISpatialReference, Serializable {

    /**
     * Creates an instance with the specified string ID.
     *
