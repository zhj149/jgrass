...
public class TestNetnumbering extends JGrassTestCase{
    ...
    public void testNetNumbering() throws IOException {
        ...
        Argument[] netnumArgs = new Argument[8];
        ...
        netnumArgs[7] = new Argument("mode", "0", true);
        ...
        // compare the result
        checkMatrixEqual(rasterData.getRenderedImage(), GrassMapTest.netNumberingChannelDataNN0, 0);
        rasterData = ((JGrassGridCoverageValueSet) valueSet1).getGridCoverage2D();
        checkMatrixEqual(rasterData.getRenderedImage(), GrassMapTest.basinDataNN0, 0);
