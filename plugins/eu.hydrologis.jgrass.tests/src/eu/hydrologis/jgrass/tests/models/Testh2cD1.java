...
import eu.hydrologis.jgrass.models.h.h2cd.h_h2cd;
...
public class Testh2cD1 extends JGrassTestCase{
    @SuppressWarnings("nls")
    public void testH2cd() throws IOException {
        ...
        h_h2cd h2cd = new h_h2cd(out, err);
        Argument[] topindexArgs = new Argument[8];
        ...
        topindexArgs[7] = new Argument("mode", "1", true);
        ...
        distArguments[0] = new Argument("ograss", "h2cd", true);
        distArguments[1] = new Argument("quantityid", "h2cd", true);
        ...
        Link ograss_link_h2cd = new Link(null, "h2cd");
        ...
        checkMatrixEqual(rasterData.getRenderedImage(), GrassMapTest.h2cdTopoData, 0.01);
        netValueSet = h2cd.getValues(null, ograss_link_h2cd.getID());
