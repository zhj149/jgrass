...
public class Testh2cd0 extends JGrassTestCase {
    ...
    public void testH2cd() throws IOException {
        ...
        topindexArgs[7] = new Argument("mode", "0", true);
        ...
        checkMatrixEqual(rasterData.getRenderedImage(), GrassMapTest.h2cdData, 0.01);
