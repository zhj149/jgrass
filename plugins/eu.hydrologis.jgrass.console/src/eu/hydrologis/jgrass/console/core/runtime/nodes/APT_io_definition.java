...
/**
 * <p>The <i>abstract parse tree</i> operator of <b>input/output definitions</b>
 * of a model.</p>
 ...
 */
public final class APT_io_definition
...
// Construction
	 ...
	 */
	public APT_io_definition( APT<APTs> operator ) {
		
		super( operator
				, APTs.APT_IO_DEFINITION.expression()
				, APTs.APT_IO_DEFINITION.annotation()
				, APTs.APT_IO_DEFINITION
			);
	} // APT_io_definition
...
// Operations
	...
	public APT<APTs> addChild( APT<APTs> operand ) {
		...
		if( operand.identifier() != APTs.APT_INPUT &&
				operand.identifier() != APTs.APT_OUTPUT )
			throw new IllegalArgumentException();
