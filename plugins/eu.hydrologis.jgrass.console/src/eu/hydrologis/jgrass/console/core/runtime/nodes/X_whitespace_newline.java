...
/**
 * <p>A <b>new line</b> - white-space; provides the pattern that
 ...
 */
public final class X_whitespace_newline
...
// Construction
	 ...
	 */
	public X_whitespace_newline( CharSequence regex ) {

		super( regex );
	} // X_whitespace_newline
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new N_whitespace_newline( sequence.toString(), line );
	} // transition
