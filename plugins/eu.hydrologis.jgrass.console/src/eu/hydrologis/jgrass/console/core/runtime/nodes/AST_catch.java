...
/**
 * <p>The <i>abstract syntax tree</i> operator of the <code><b>catch</b></code>
 * keyword of a <code>try</code>-<code>catch</code> block statement, e.g.,
 * "<b>catch(</b> operand1 operand2 ... <b>)</b>".</p>
...
// Construction
	 ...
	 * 		operands.
	 */
	public AST_catch( AST<ASTs>... operands ) {
	
		super( ASTs.AST_CATCH.expression()
				, ASTs.AST_CATCH.annotation()
				, ASTs.AST_CATCH
				, operands
			);
	} // AST_catch
