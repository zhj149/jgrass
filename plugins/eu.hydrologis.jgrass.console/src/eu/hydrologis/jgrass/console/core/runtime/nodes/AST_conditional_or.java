...
/**
 * <p>The <i>abstract syntax tree</i> operator of a <b><i>conditional or</i></b>
 * - <b>||</b> - <b><i>releation</i></b>, e.g.,
 ...
 */
public class AST_conditional_or
...
// Construction
	 ...
	 * 		operands.
	 */
	public AST_conditional_or( AST<ASTs>... operands ) {
	
		super( ASTs.AST_CONDITIONAL_OR.expression()
				, ASTs.AST_CONDITIONAL_OR.annotation()
				, ASTs.AST_CONDITIONAL_OR
				, operands
			);
	} // AST_conditional_or
