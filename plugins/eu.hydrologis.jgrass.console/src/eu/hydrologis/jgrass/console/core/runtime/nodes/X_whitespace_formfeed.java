...
/**
 * <p>A <b>form-feed character</b> - white-space; provides the pattern that
 ...
 */
public final class X_whitespace_formfeed
...
// Construction
	 ...
	 */
	public X_whitespace_formfeed( CharSequence regex ) {
	
		super( regex );
	} // X_whitespace_formfeed
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new N_whitespace_formfeed( sequence.toString(), line );
	} // transition
