...
/**
 * <p>A <b>left curly bracket</b>; provides the pattern that matches this kind
 ...
 */
public final class X_braceopen
...
// Construction
	 ...
	 */
	public X_braceopen( CharSequence regex ) {
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new T_braceopen( sequence.toString(), line );
	} // transition
