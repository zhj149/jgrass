...
/**
 * <p>The <b>R directive</b>; provides the pattern that matches this kind
 ...
 */
public final class X_directive_r
...
// Construction
	 ...
	 */
	public X_directive_r( CharSequence regex ) {
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new T_directive_r( sequence.toString(), line );
	} // transition
