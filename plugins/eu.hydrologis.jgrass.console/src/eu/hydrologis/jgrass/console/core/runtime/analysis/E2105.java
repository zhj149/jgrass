...
/**
 * <h1>Compiler Error 2106</h1>
 * <h2>Error Message</h2>
 * <p>missing java model identifier before 'token'.</p>
...
// Construction
	 ...
	 * 		- the token.
	 */
	public E2105( Projectspace projectSpace, Token<TOKs> token ) {
	
		super(
			MessageFormat.format(
					"{0}({1}) : error {2}: missing java model identifier before ''{3}''."
					, new Object[] {
						projectSpace.projectCaption()
						, token.line()
						, E2105.class.getSimpleName()
						, token.expression()
					}
				)
			);
