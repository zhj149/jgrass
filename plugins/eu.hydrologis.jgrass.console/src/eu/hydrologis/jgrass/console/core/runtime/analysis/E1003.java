...
/**
 * <h1>Compiler Error 1003</h1>
 * <h2>Error Message</h2>
 * <p>syntax error : missing 'token' after identifier 'identifier'.</p>
...
// Construction
	/**
	 * <p>The constructor <code>E1003</code> constructs the message.</p>
	 * @param projectSpace
	 ...
	 * 		- the missing token.
	 */
	public E1003( Projectspace projectSpace, Token<TOKs> token,
			String missing ) {
	
		super(
			MessageFormat.format(
					"{0}({1}) : error {2}: syntax error : missing ''{4}'' after identifier ''{3}''."
					, new Object[] {
						projectSpace.projectCaption()
						, token.line()
						, E1003.class.getSimpleName()
						, token.expression()
						, missing
					}
				)
