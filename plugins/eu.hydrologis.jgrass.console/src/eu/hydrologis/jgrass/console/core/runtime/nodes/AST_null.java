...
/**
 * <p>The <i>abstract syntax tree</i> operand represents the <code>null</code>
 * keyword, e.g., "<b>null</b>".</p>
...
// Construction
	...
	public AST_null() {
		...
		super( ASTs.AST_NULL.expression()
				, ASTs.AST_NULL.annotation()
				, ASTs.AST_NULL
			);
	} // AST_null
