...
/**
 * <p>A <b>word</b>; provides the pattern that matches this kind of lexical
 * unit. A lexical analyzer uses the implemented functionality to verify if the
 * sequence of input characters matches the pattern and also the functionality
 * of transition into a token.</p>
...
// Construction
	 ...
	 */
	public X_word( CharSequence regex ) {
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new N_word( sequence.toString(), line );
	} // transition
