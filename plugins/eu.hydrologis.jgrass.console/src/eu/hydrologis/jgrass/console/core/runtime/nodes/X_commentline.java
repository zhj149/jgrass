...
/**
 * <p>A <b>single-line comment</b>; provides the pattern that matches this kind
 * of lexical unit. A lexical analyzer uses the implemented functionality to
 * verify if the sequence of input characters matches the pattern and also the
 * functionality of transition into a token.</p>
 ...
 */
public final class X_commentline
    extends AbstractLexeme<TOKs>
    implements Lexeme<TOKs> {

// Construction
	/* (non-Javadoc)
	 * @see eu.hydrologis.jgrass.console.core.internal.nodes.AbstractLexeme#AbstractLexeme(X,CharSequence,int)
	 */
	public X_commentline( CharSequence regex ) {
		
		super( regex, Pattern.MULTILINE );
	} // X_commentline
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new T_commentline( sequence.toString(), line );
	} // transition
