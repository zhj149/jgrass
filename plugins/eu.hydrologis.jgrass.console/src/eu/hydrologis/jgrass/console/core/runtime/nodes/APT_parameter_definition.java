...
/**
 * <p>The <i>abstract parse tree</i> operator of <b>parameter definitions</b>
 * for a command.</p>
 ...
 */
public final class APT_parameter_definition
...
// Construction
	 ...
	 */
	public APT_parameter_definition( APT<APTs> operator ) {
		
		super( operator
				, APTs.APT_PARAMETER_DEFINITION.expression()
				, APTs.APT_PARAMETER_DEFINITION.annotation()
				, APTs.APT_PARAMETER_DEFINITION
			);
	} // APT_parameter_definition
...
// Operations
	...
	public APT<APTs> addChild( APT<APTs> operand ) {
		...
		if( operand.identifier() != APTs.APT_PARAMETER )
			throw new IllegalArgumentException();
