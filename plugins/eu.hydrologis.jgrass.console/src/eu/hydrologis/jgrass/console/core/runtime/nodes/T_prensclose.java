...
/**
 * <p>The class <code>T_prensclose</code> represents the terminal token of
 * <b>right parenthesis</b>.</p>
 * @see eu.hydrologis.jgrass.console.core.internal.nodes.Token
 * @since 2.0.0
 * @version 1.0.0.1
 * @author Andreas Hamm (aha), ahamm@andreas-hamm.de
 */
public final class T_prensclose
	extends AbstractToken<TOKs>
	implements Token<TOKs> {

// Attributes
	/** The tokens identity name. */
	public final static TOKs identifier = TOKs.CHARACTER_PRENS_CLOSE;
...
// Construction
	 ...
	 */
	public T_prensclose( String expression, int line ) {
