...
/**
 * <p>A <b>closing square bracket</b>; provides the pattern that matches this kind
 ...
 */
public final class X_bracketclose 
...
// Construction
	 ...
	 */
	public X_bracketclose( CharSequence regex ) {
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new T_bracketclose( sequence.toString(), line );
	} // transition
