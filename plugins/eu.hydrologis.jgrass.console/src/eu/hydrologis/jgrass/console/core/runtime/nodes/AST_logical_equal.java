 ...
 * <b><i>equal</i></b>, e.g., "oparand1 <b>==</b> operand2".</p>
 ...
 */
public final class AST_logical_equal
...
// Construction
	 ...
	 * 		operands.
	 */
	public AST_logical_equal( AST<ASTs>... operands ) {
	
		super( ASTs.AST_LOGICAL_EQUAL.expression()
				, ASTs.AST_LOGICAL_EQUAL.annotation()
				, ASTs.AST_LOGICAL_EQUAL
				, operands
			);
	} // AST_logical_equal
