...
/**
 * <p>A <i>GRASS</i> <b>native model</b> respectively command; provides the
 * pattern that matches this kind of lexical unit. A lexical analyzer uses the
 ...
 */
public final class X_native_model
...
// Construction
	 ...
	 */
	public X_native_model( CharSequence keyword, CharSequence regex ) {
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new N_native_model( sequence.toString(), line );
	} // transition
