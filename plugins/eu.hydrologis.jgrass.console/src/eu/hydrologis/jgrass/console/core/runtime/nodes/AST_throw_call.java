...
/**
 * <p>The <i>abstract syntax tree</i> operator of the <code><b>throw</b></code>
 * keyword, e.g., "<b>throw</b> operand1 operand2 ... ".</p>
 ...
 * <code><pre>
 * <b>new</b> AST_throw_call(
 * 	<b>new</b> AST_ctor_call(
 * 		<b>new</b> AST_identifier( "RuntimeException" )
 * 		, <b>new</b> AST_elist()
 * 		)
 * 	);
 * </pre></code></p>
 ...
 */
public final class AST_throw_call
...
// Construction
	 ...
	 * 		operands.
	 */
	public AST_throw_call( AST<ASTs>... operands ) {
		
		super( ASTs.AST_THROW_CALL.expression()
				, ASTs.AST_THROW_CALL.annotation()
				, ASTs.AST_THROW_CALL
				, operands
			);
	} // AST_throw_call
