...
/**
 * <p>A non-terminal <b>form-feed</b> character - white-space - token.</p>
 * @see eu.hydrologis.jgrass.console.core.internal.nodes.Token
 * @since 2.0.0
 * @version 1.0.0.1
 * @author Andreas Hamm (aha), ahamm@andreas-hamm.de
 */
public final class N_whitespace_formfeed 
	extends AbstractToken<TOKs>
	implements Token<TOKs> {

// Attributes
	/** The tokens identity name. */
	public final static TOKs identifier = TOKs.CHARACTER_FORM_FEED;
...
// Construction
	 ...
	 */
	public N_whitespace_formfeed( String expression, int line ) {
	
		super( expression, line );
	} // N_whitespace_formfeed
