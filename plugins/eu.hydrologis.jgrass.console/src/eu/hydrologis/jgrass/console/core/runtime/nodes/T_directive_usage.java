...
/**
 * <p>The class <code>T_directive_usage</code> represents the terminal token
 * of the <b>--help</b> directive.</p>
 * @see eu.hydrologis.jgrass.console.core.internal.nodes.Token
 * @since 2.0.0
 * @version 1.0.0.1
 * @author Andreas Hamm (aha), ahamm@andreas-hamm.de
 */
public final class T_directive_usage
	extends AbstractToken<TOKs>
	implements Token<TOKs> {

//Attributes
	/** The tokens identity name. */
	public final static TOKs identifier = TOKs.DIRECTIVE_USAGE;
...
// Construction
	 ...
	 */
	public T_directive_usage( String expression, int line ) {
