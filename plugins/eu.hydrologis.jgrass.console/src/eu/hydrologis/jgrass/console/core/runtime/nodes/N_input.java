...
/**
 * <p>A non-terminal <b>input</b> token.</p>
 * @see eu.hydrologis.jgrass.console.core.internal.nodes.Token
 * @since 2.0.0
 * @version 1.0.0.1
 * @author Andreas Hamm (aha), ahamm@andreas-hamm.de
 */
public final class N_input
	extends AbstractToken<TOKs>
	implements Token<TOKs> {

// Attributes
	/**
	 * The input has a postfix asterisk operator <code>true</code>, otherwise
	 * <code>false</code>.
	 */
	private boolean m_asterisk;
	
	/** The input exchange item keyword. */
	private String m_type;
	
	/** The quantity keyword. */
	...
	public final static TOKs identifier = TOKs.INPUT;
...
// Construction
	 ...
	 */
	public N_input( String expression, int line, Character asterisk ) {
...
// Operations
	...
	/**
	 * <p>Returns the type name of the linkable input component.</p>
	 */
	public String type() {
    ...
    public String toString()
    {
        ...
        retValue.append("N_input (").append(LF)
