...
/**
 * <p>A <b>assign character</b>; provides the pattern that matches this kind of
...
// Construction
	 ...
	 */
	public X_assign( CharSequence regex ) {
...
// Operations	
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new T_assign( sequence.toString(), line );
	} // transition
