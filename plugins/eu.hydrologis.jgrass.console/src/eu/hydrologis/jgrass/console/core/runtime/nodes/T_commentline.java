...
/**
 * <p>The class <code>T_commentline</code> represents the terminal token of
 * a single-line <b>comment</b>.</p>
 * @see eu.hydrologis.jgrass.console.core.internal.nodes.Token
 * @since 2.0.0
 * @version 1.0.0.1
 * @author Andreas Hamm (aha), ahamm@andreas-hamm.de
 */
public final class T_commentline
    extends AbstractToken<TOKs>
    implements Token<TOKs> {

// Attributes
	/** The tokens identity name. */
	public final static TOKs identifier = TOKs.COMMENT_LINE;
...
// Construction
	 ...
	 */
	public T_commentline( String expression, int line ) {
