...
/**
 * <p>A <b>space character</b> - white-space; provides the pattern that
 ...
 */
public final class X_whitespace_blank
...
// Construction
	 ...
	 */
	public X_whitespace_blank( CharSequence regex ) {
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new N_whitespace_blank( sequence.toString(), line );
	} // transition
