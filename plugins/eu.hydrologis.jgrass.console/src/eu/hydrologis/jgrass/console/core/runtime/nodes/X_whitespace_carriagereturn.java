...
/**
 * <p>A <b>carriage-return character</b> - white-space; provides the pattern
 * that matches this kind of lexical unit. A lexical analyzer uses the
 * implemented functionality to verify if the sequence of input characters
 * matches the pattern and also the functionality of transition into a
 * token.</p>
 ...
 */
public final class X_whitespace_carriagereturn
...
//Construction
	 ...
	 */
	public X_whitespace_carriagereturn( CharSequence regex ) {
	
		super( regex );
	} // X_whitespace_carriagereturn
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new N_whitespace_carriagereturn( sequence.toString(), line );
	} // transition
