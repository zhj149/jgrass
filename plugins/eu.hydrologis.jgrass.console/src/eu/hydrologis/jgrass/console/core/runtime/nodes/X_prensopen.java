...
/**
 * <p>A <b>left parenthesis</b>; provides the pattern that matches this kind of
 * lexical unit. A lexical analyzer uses the implemented functionality to verify
 * if the sequence of input characters matches the pattern and also the
 ...
 */
public final class X_prensopen
...
// Construction
	 ...
	 */
	public X_prensopen( CharSequence regex ) {
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new T_prensopen( sequence.toString(), line );
	} // transition
