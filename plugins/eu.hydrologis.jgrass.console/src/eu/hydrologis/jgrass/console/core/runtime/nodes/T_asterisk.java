...
/**
 * <p>The class <code>T_asterisk</code> represents the terminal token of the
 * <b>asterisk</b> operator.</p>
 * @see eu.hydrologis.jgrass.console.core.internal.nodes.Token
 * @since 2.0.0
 * @version 1.0.0.1
 * @author Andreas Hamm (aha), ahamm@andreas-hamm.de
 */
public final class T_asterisk
	extends AbstractToken<TOKs>
	implements Token<TOKs> {

// Attributes
	/** The tokens identity name. */
	public final static TOKs identifier = TOKs.CHARACTER_ASTERISK;
...
// Construction
	 ...
	 */
	public T_asterisk( String expression, int line ) {
