...
/**
 * <p>A <b>opening square bracket</b>; provides the pattern that matches this kind
 ...
 */
public final class X_bracketopen
...
// Construction
	 ...
	 */
	public X_bracketopen( CharSequence regex ) {
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new T_bracketopen( sequence.toString(), line );
	} // transition
