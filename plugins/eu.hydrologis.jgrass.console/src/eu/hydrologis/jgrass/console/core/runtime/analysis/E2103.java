...
/**
 * <h1>Compiler Error 2103</h1>
 * <h2>Error Message</h2>
 * <p>unexpected java model identifier 'identifier'.</p>
...
// Construction
	 ...
	 * 		- the identifier.
	 */
	public E2103( Projectspace projectSpace, Token<TOKs> token ) {

		super(
			MessageFormat.format(
					"{0}({1}) : error {2}: unexpected java model identifier ''{3}''."
					, new Object[] {
						projectSpace.projectCaption()
						, token.line()
						, E2103.class.getSimpleName()
						, token.expression()
					}
				)
			);
