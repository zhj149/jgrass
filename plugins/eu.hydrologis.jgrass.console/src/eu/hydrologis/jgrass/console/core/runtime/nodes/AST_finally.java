 ...
 */
public final class AST_finally
...
// Construction
	 ...
	 * 		operands.
	 */
	public AST_finally( AST<ASTs>... operands ) {
	
		super( ASTs.AST_FINALLY.expression()
				, ASTs.AST_FINALLY.annotation()
				, ASTs.AST_FINALLY
				, operands
			);
	} // AST_finally
