...
/**
 * <p>The <i>abstract syntax tree</i> operator represents the <b><i>parenthesis
 * of conditions</i></b>, e.g., "<b>(</b> operand1 operand2 ... <b>)</b>".</p>
 ...
 */
public final class AST_condition
...
// Construction
	 ...
	 * 		operands.
	 */
	public AST_condition( AST<ASTs>... operands ) {
	
		super( ASTs.AST_CONDITION.expression()
				, ASTs.AST_CONDITION.annotation()
				, ASTs.AST_CONDITION
				, operands
			);
	} // AST_condition
