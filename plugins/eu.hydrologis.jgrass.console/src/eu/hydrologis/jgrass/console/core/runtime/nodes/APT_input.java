...
/**
 * <p>The <i>abstract parse tree</i> operator of an <b>input argument</b> of
 * a model.</p>
 ...
 */
public final class APT_input extends AbstractAPT<APTs> implements APT<APTs> {
    ...
    /** The token of the argument flag. */
     ...
     */
    public APT_input( APT<APTs> operator, Token<TOKs> lvalue, String linkable_variable_name,
            String linkable_type_name, String link_variable_name, String link_type_name,
            Token<TOKs> rvalue ) {

        super(operator, AbstractToken.__safe_expression(lvalue), APTs.APT_INPUT.annotation(),
                APTs.APT_INPUT);
     ...
     * component.</p>
     */
    public APT_argument_definition argument_def() {
     ...
     */
    public N_input token_flag() {

        return (N_input) m_token_lvalue;
    } // token_flag
