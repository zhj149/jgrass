...
/**
 * <p>The class <code>T_commentblock</code> represents the terminal token of
 * a multi-line <b>comment</b>.</p>
 * @see eu.hydrologis.jgrass.console.core.internal.nodes.Token
 * @since 2.0.0
 * @version 1.0.0.1
 * @author Andreas Hamm (aha), ahamm@andreas-hamm.de
 */
public final class T_commentblock
    extends AbstractToken<TOKs>
    implements Token<TOKs> {
	
// Attributes
	/** The tokens identity name. */
	public final static TOKs identifier = TOKs.COMMENT_BLOCK;
...
// Construction
	 ...
	 */
	public T_commentblock( String expression, int line ) {
