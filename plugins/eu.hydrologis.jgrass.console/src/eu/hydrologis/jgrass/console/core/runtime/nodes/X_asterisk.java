...
/**
 * <p>A <b>asterisk character</b>; provides the pattern that matches this kind
...
// Construction
	 ...
	 */
	public X_asterisk( CharSequence regex ) {
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new T_asterisk( sequence.toString(), line );
	} // transition
