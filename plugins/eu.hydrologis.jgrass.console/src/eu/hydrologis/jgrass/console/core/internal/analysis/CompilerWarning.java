...
// Construction
	/**
	 * <p>Constructs a new warning exception with null as its detail message.
	...
	/**
	 * <p>Constructs a new warning exception with the specified detail message.
	 * The cause is not initialized, and may subsequently be initialized by a
	 * call to <code>Throwable.initCause(java.lang.Throwable)</code>.</p>
	 * @param message
	...
	/**
	 * <p>Constructs a new warning exception with the specified detail message
	 * and cause.</p><p>Note that the detail message associated with cause is
	 ...
	 * 		or unknown.
	 */
	public CompilerWarning( String message, Throwable cause ) {
		
		super( message, cause );
	} // Warning
	
	/**
	 * <p>Constructs a new warning exception with the specified cause and a
	 ...
	 * 		or unknown.
	 */
	public CompilerWarning( Throwable cause ) {
