...
/**
 * <p>The <b>jgrass directive</b>; provides the pattern that matches this kind
 ...
 */
public final class X_directive_jgrass
...
// Construction
	 ...
	 */
	public X_directive_jgrass( CharSequence regex ) {
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new T_directive_jgrass( sequence.toString(), line );
	} // transition
