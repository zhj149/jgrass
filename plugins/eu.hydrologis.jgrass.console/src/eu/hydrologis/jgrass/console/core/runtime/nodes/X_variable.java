...
/**
 * <p>A <i>JGRASS</i> <b>variable</b>; provides the pattern that matches this
...
// Construction
	 ...
	 */
	public X_variable( CharSequence regex ) {
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new N_variable( sequence.toString(), line );
	} // transition
