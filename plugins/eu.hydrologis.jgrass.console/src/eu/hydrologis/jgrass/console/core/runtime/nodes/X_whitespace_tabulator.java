...
/**
 * <p>A <b>tabulator character</b> - white-space; provides the pattern that
 ...
 */
public final class X_whitespace_tabulator
...
// Construction
	 ...
	 */
	public X_whitespace_tabulator( CharSequence regex ) {
	
		super( regex );
	} // X_whitespace_tabulator
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new N_whitespace_tabulator( sequence.toString(), line );
	} // transition
