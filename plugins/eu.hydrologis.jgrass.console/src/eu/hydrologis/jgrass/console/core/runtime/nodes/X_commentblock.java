...
/**
 * <p>A <b>multi-line comment</b>; provides the pattern that matches this kind
 ...
 */
public final class X_commentblock
...
// Construction
	 ...
	 */
	public X_commentblock( CharSequence regex ) {
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new T_commentblock( sequence.toString(), line );
	} // transition
