...
/**
 * <p>The class <code>T_braceopen</code> represents the terminal token of
 * a <b>left curly bracket</b>.</p>
 * @see eu.hydrologis.jgrass.console.core.internal.nodes.Token
 * @since 2.0.0
 * @version 1.0.0.1
 * @author Andreas Hamm (aha), ahamm@andreas-hamm.de
 */
public final class T_braceopen
    extends AbstractToken<TOKs>
    implements Token<TOKs> {

// Attributes
	/** The tokens identity name. */
	public final static TOKs identifier = TOKs.CHARACTER_BRACE_OPEN;
...
// Construction
	 ...
	 */
	public T_braceopen( String expression, int line ) {
