...
/**
 * <p>The production for a input argument of a <i>JGRASS</i> model.</p>
 * @since 2.0.0
 * @version 1.0.0.1
 * @author Andreas Hamm (aha), ahamm@andreas-hamm.de
 */
public final class P_input
    extends AbstractProduction<APTs, TOKs, SYMs>
    implements Production<APTs, TOKs, SYMs> {

// Attributes
	/** Alternative production for a none-nested input argument. */
...
// Operations
	...
	public TOKs[][] produces( APT<APTs> parseTree ) {
		...
		if( null == parent || APTs.APT_INPUT != parent.identifier() )
	...
	public APT<APTs> translate( Symtable<SYMs> symtable,
		...
		try {
			...
			case 2:
				final N_input lvalue     = ( N_input )tstream[ 0 ];
				...
				final APT_input __input = new APT_input(
						__iodefs
						, lvalue
						, variable_linkable_name
						, symbole.type()
				...
				__argsdef = ( APT_argument_definition )__input.argument_def();
				...
				case CHARACTER_BRACKET_OPEN:
					...
					retval = __input.nested_statement();
					break;
