...
/**
 * <p>The <i>abstract syntax tree</i> operator for <b><i>dot</i></b>
...
// Construction
	 ...
	 * 		operands.
	 */
	public AST_dot( AST<ASTs>... operands ) {
	
		super( ASTs.AST_DOT.expression()
				, ASTs.AST_DOT.annotation()
				, ASTs.AST_DOT
				, operands
			);
	} // AST_dot
