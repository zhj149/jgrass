...
/**
 * <p>The <i>abstract syntax tree</i> operator of a code <b><i>block</i></b>,
 * e.g., "<b>{</b> operand1 operand2 ... <b>}</b>".</p>
...
// Construction
	 ...
	 * 		operands.
	 */
	public AST_block( AST<ASTs>... operands ) {
		
		super( ASTs.AST_BLOCK.expression()
				, ASTs.AST_BLOCK.annotation()
				, ASTs.AST_BLOCK
				, operands
			);
	} // AST_block
