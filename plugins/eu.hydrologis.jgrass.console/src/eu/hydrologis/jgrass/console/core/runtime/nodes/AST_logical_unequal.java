...
/**
 * <p>The <i>abstract syntax tree</i> operator for the logical condition
 * <b><i>not equal</i></b>, e.g., "oparand1 <b>!=</b> operand2".</p>
 ...
 */
public final class AST_logical_unequal
...
// Construction
	 ...
	 * 		operands.
	 */
	public AST_logical_unequal( AST<ASTs>... operands ) {
	
		super( ASTs.AST_LOGICAL_UNEQUAL.expression()
				, ASTs.AST_LOGICAL_UNEQUAL.annotation()
				, ASTs.AST_LOGICAL_UNEQUAL
				, operands
			);
	} // AST_logical_unequal
