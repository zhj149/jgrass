...
/**
 * <p>The <i>abstract parse tree</i> operator of <b>argument definitions</b>,
 * either of a simulation model or of a linkable input/output exchange in a
 * Java based model statement - an argument definition operator has as operands
 * only one or more argument expressions.</p>
 ...
 */
public final class APT_argument_definition
...
// Construction
	 ...
	 */
	public APT_argument_definition( APT<APTs> operator ) {
		
		super( operator
				, APTs.APT_ARGUMENT_DEFINITION.expression()
				, APTs.APT_ARGUMENT_DEFINITION.annotation()
				, APTs.APT_ARGUMENT_DEFINITION
			);
...
// Operations
	...
	public APT<APTs> addChild( APT<APTs> operand ) {
		...
		if( operand.identifier() != APTs.APT_ARGUMENT )
			throw new IllegalArgumentException();
