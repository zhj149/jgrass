...
/**
 * <p>The <b>/compile directive</b>; provides the pattern that matches this kind
 ...
 */
public final class X_directive_compile
...
// Construction
	 ...
	 */
	public X_directive_compile( CharSequence regex ) {
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new T_directive_compile( sequence.toString(), line );
	} // transition
