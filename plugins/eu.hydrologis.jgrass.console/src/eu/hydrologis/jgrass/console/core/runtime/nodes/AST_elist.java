...
/**
 * <p>The <i>abstract syntax tree</i> operator for a <b><i>list of
 * elements</i></b>, e.g., "<b>(</b> oparand1<b>,</b> operand2<b>,</b> ...
 * <b>)</b>".</p>
...
// Construction
	...
	public AST_elist() {
		...
		super( ASTs.AST_ELIST.expression()
				, ASTs.AST_ELIST.annotation()
				, ASTs.AST_ELIST
			);
	} // AST_elist
	 ...
	 * 		operands.
	 */
	public AST_elist( AST<ASTs>... operands ) {
