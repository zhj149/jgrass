...
/**
 * <p>A <b>right curly bracket</b>; provides the pattern that matches this kind
 ...
 */
public final class X_braceclose
...
// Construction
	 ...
	 */
	public X_braceclose( CharSequence regex ) {
...
// Operations	
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new T_braceclose( sequence.toString(), line );
	} // transition
