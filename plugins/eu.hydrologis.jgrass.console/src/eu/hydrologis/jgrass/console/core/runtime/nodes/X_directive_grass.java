...
/**
 * <p>The <b>grass directive</b>; provides the pattern that matches this kind
 ...
 */
public final class X_directive_grass
...
// Construction
	 ...
	 */
	public X_directive_grass( CharSequence regex ) {
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new T_directive_grass( sequence.toString(), line );
	} // transition
