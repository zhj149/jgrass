...
/**
 * <h1>Compiler Error 2111</h1>
 * <h2>Error Message</h2>
 * <p>argument value expected after 'identifier'.</p>
...
// Construction
	/**
	 * <p>The constructor <code>E2111</code> constructs the message.</p>
	 * @param projectSpace
	 * 		- the current project space.
	 * @param token
	 * 		- the token.
	 */
	public E2111( Projectspace projectSpace, Token<TOKs> token ) {

		super(
			MessageFormat.format(
					"{0}({1}) : error {2}: argument value expected after ''{3}''."
					, new Object[] {
