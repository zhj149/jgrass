...
/**
 * <p>A <b>backspace character</b> - white-space; provides the pattern that
 * matches this kind of lexical unit. A lexical analyzer uses the implemented
 ...
 */
public final class X_whitespace_backspace
...
// Construction
	 ...
	 */
	public X_whitespace_backspace( CharSequence regex ) {
	
		super( regex );
	} // X_whitespace_backspace
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new N_whitespace_backspace( sequence.toString(), line );
	} // transition
