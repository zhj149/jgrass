...
/**
 * <p>A <b>pathname</b>; provides the pattern that matches this kind of lexical
 * unit. A lexical analyzer uses the implemented functionality to verify
...
// Construction
	 ...
	 */
	public X_pathname( CharSequence regex ) {
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new N_pathname( sequence.toString(), line );
	} // transition
