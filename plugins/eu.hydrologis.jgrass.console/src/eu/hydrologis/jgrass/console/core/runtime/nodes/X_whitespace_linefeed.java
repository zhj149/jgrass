...
/**
 * <p>A <b>line-feed character</b> - white-space; provides the pattern that
 ...
 */
public final class X_whitespace_linefeed
...
// Construction
	 ...
	 */
	public X_whitespace_linefeed( CharSequence regex ) {
	
		super( regex );
	} // X_whitespace_linefeed
...
// Operations
	...
	public Token<TOKs> transition( CharSequence sequence, int line ) {
		...
		return new N_whitespace_linefeed( sequence.toString(), line );
	} // transition
