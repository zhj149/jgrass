...
/**
 * <p>The class <code>T_directive_compile</code> represents the terminal token
 * of the <b>/compile</b> directive.</p>
 * @see eu.hydrologis.jgrass.console.core.internal.nodes.Token
 * @since 2.0.0
 * @version 1.0.0.1
 * @author Andreas Hamm (aha), ahamm@andreas-hamm.de
 */
public final class T_directive_compile 
	extends AbstractToken<TOKs>
	implements Token<TOKs> {

// Attributes
	/** The tokens identity name. */
	public final static TOKs identifier = TOKs.DIRECTIVE_COMPILE;
...
// Construction
	 ...
	 */
	public T_directive_compile( String expression, int line ) {
