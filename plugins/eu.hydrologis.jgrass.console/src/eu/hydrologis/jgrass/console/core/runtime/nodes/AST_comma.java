...
/**
 * <p>The <i>abstract syntax tree</i> operator for <b><i>comma</i></b>
 * punctuation, e.g., "oparand1<b>,</b> operand2<b>,</b> ...".</p>
 ...
 * 		, <b>new</b> AST_literal( "literal string" )
 * 		, ...
 * 		)
 * 	);
 * </pre></code></p>
...
// Construction
	 ...
	 * 		operands.
	 */
	public AST_comma( AST<ASTs>... operands ) {
	
		super( ASTs.AST_COMMA.expression()
				, ASTs.AST_COMMA.annotation()
				, ASTs.AST_COMMA
				, operands
			);
	} // AST_comma
