...
/**
 * <p>The class <code>T_directive_jgrass</code> represents the terminal token
 * of the <b>jgrass</b> directive.</p>
 * @see eu.hydrologis.jgrass.console.core.internal.nodes.Token
 * @since 2.0.0
 * @version 1.0.0.1
 * @author Andreas Hamm (aha), ahamm@andreas-hamm.de
 */
public final class T_directive_jgrass 
	extends AbstractToken<TOKs>
	implements Token<TOKs> {

// Attributes
	/** The tokens identity name. */
	public final static TOKs identifier = TOKs.DIRECTIVE_JGRASS;
...
// Construction
	 ...
	 */
	public T_directive_jgrass( String expression, int line ) {
