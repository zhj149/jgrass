...
/**
 * <p>The <i>abstract syntax tree</i> operator of the <b><i>else</i></b> block
 * respectively the <code><b>else</b></code> keyword of an <code>if</code>
 * statement, e.g., "<b>else</b> <b>{</b> operand ... <b>}</b>".</p>
...
// Construction
	 ...
	 * 		operands.
	 */
	public AST_else( AST<ASTs>... operands ) {
	
		super( ASTs.AST_ELSE.expression()
				, ASTs.AST_ELSE.annotation()
				, ASTs.AST_ELSE
				, operands
			);
	} // AST_else
