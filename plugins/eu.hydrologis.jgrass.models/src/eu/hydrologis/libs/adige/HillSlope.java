...
import eu.hydrologis.jgrass.models.h.adige.Evapotranspiration;
...
public class HillSlope implements Comparator<HillSlope> {
    ...
    public HillSlope( SimpleFeature netFeature, SimpleFeature basinFeature, PfafstetterNumber pfafNumber,
            int hillslopeId, int baricenterElevationFieldIndex, int linkStartElevationFieldIndex,
            int linkEndElevationFieldIndex, int vegetationIdFieldIndex ) {
     ...
     * @return
     */
    public Geometry getGeometry( List<PfafstetterNumber> limit, IProgressMonitor pm,
            boolean doMonitor ) {
