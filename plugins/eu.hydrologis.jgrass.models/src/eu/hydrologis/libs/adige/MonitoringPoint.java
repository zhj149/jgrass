...
public abstract class MonitoringPoint
     ...
     * 
     * @param date the date for which teh value is requested ({@link MonitoringPoint#novalue} is
     ...
     */
    public FeatureCollection toFeatureCollection( List<MonitoringPoint> monitoringPointsList ) {

        // create the feature type
        SimpleFeatureTypeBuilder b = new SimpleFeatureTypeBuilder();
        // set the name
        b.setName("monitoringpoints"); //$NON-NLS-1$
        // add a geometry property
        b.add("the_geom", Point.class); //$NON-NLS-1$
        // add some properties
        b.add("id", Integer.class); //$NON-NLS-1$
        b.add("relatedid", Integer.class); //$NON-NLS-1$
        b.add("pfaf", String.class); //$NON-NLS-1$
        // build the type
