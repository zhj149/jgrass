 ...
 */
package eu.hydrologis.jgrass.models.h.adige;
...
import eu.hydrologis.libs.adige.Dams;
import eu.hydrologis.libs.adige.DischargeContributor;
import eu.hydrologis.libs.adige.HillSlope;
import eu.hydrologis.libs.adige.Hydrometers;
import eu.hydrologis.libs.adige.NetBasinsManager;
import eu.hydrologis.libs.adige.Offtakes;
import eu.hydrologis.libs.adige.PfafstetterNumber;
import eu.hydrologis.libs.adige.Tributaries;
import eu.hydrologis.libs.duffy.DischargeDistributor;
import eu.hydrologis.libs.duffy.DuffyModel;
import eu.hydrologis.libs.duffy.RungeKuttaFelberg;
 ...
 */
public class h_adige extends ModelsBackbone {

    private static final String OUTPUTPFAFSTETTER = "outpfafids"; //$NON-NLS-1$
    private static final String ENDELEVATTR = "endelevattr"; //$NON-NLS-1$
    private static final String STARTELEVATTR = "startelevattr"; //$NON-NLS-1$
    private static final String BARICENTERATTR = "baricenterattr"; //$NON-NLS-1$
    private static final String PFAFATTR = "pfafattr"; //$NON-NLS-1$
    private static final String NETNUMATTR = "netnumattr"; //$NON-NLS-1$
    private static final String MONPOINTIDATTR = "idmonpointattr"; //$NON-NLS-1$
    private static final String ROUTING = "routing"; //$NON-NLS-1$
    private static final String RAININTENSITY = "rainintensity"; //$NON-NLS-1$
    private static final String RAINDURATION = "rainduration"; //$NON-NLS-1$
    private static final String VEGETATION = "vegetation"; //$NON-NLS-1$
    private static final String LOG = "log"; //$NON-NLS-1$

    public final static String dischargeOutputID = "discharge"; //$NON-NLS-1$
    public final static String s1OutputID = "s1"; //$NON-NLS-1$
    public final static String s2OutputID = "s2"; //$NON-NLS-1$
    public final static String s3OutputID = "s3"; //$NON-NLS-1$
    public final static String basinrainOutputID = "brain"; //$NON-NLS-1$
    public final static String netpfafInputID = "netpfaf"; //$NON-NLS-1$
    public final static String vegetationInputID = "vegetation"; //$NON-NLS-1$
    public final static String hillslopeInputID = "hillslope"; //$NON-NLS-1$
    public final static String rainfallInputID = "rain"; //$NON-NLS-1$
    public final static String boundaryOutputID = "boundaryout"; //$NON-NLS-1$
    public final static String boundaryInputID = "boundaryin"; //$NON-NLS-1$
    public final static String hydrometersFeaturesInputID = "hfeatures"; //$NON-NLS-1$
    public final static String hydrometersDataInputID = "hdata"; //$NON-NLS-1$
    public final static String damsFeaturesInputID = "dfeatures"; //$NON-NLS-1$
    public final static String damsOverflowDischargeInputID = "ddata"; //$NON-NLS-1$
    public final static String tributaryFeaturesInputID = "tfeatures"; //$NON-NLS-1$
    public final static String tributaryDischargeInputID = "tdata"; //$NON-NLS-1$
    public final static String offtakesFeaturesInputID = "ofeatures"; //$NON-NLS-1$
    public final static String offtakesDischargeInputID = "odata"; //$NON-NLS-1$
    public final static String params_avg_sup_10 = "avgsup10";
    public final static String params_avg_sup_30 = "avgsup30";
    public final static String params_avg_sup_60 = "avgsup60";
    public final static String params_var_sup_10 = "varsup10";
    public final static String params_var_sup_30 = "varsup30";
    public final static String params_var_sup_60 = "varsup60";
    public final static String params_avg_sub = "avgsub";
    public final static String params_var_sub = "varsub";
    public final static String params_v_sup = "vsup";
    public final static String params_v_sub = "vsub";

    private final static String modelParameters = "";

    private String PARAMS_AVG_SUP_10 = null;
    private String PARAMS_AVG_SUP_30 = null;
    private String PARAMS_AVG_SUP_60 = null;
    private String PARAMS_VAR_SUP_10 = null;
    private String PARAMS_VAR_SUP_30 = null;
    private String PARAMS_VAR_SUP_60 = null;
    private String PARAMS_AVG_SUB = null;
    private String PARAMS_VAR_SUB = null;
    private String PARAMS_V_SUP = null;
    private String PARAMS_V_SUB = null;

    private ILink netpfafInputLink = null;
    private ILink vegetationInputLink = null;
    private ILink hillslopeInputLink = null;
    private ILink rainfallInputLink = null;
    private ILink hydrometersDataInputLink = null;
    private ILink hydrometersFeaturesInputLink = null;
    private ILink damsFeaturesInputLink = null;
    private ILink damsOverflowDischargeInputLink = null;
    private ILink tributaryFeaturesInputLink = null;
    private ILink tributaryDischargeInputLink = null;
    private ILink offtakesFeaturesInputLink = null;
    private ILink offtakesDischargeInputLink = null;
    private ILink dischargeOutputLink = null;
    private ILink s1OutputLink = null;
    private ILink s2OutputLink = null;
    private ILink s3OutputLink = null;
    private ILink basinrainOutputLink = null;
    /**
     * The initial conditions link.
     * 
     * <p>
     * The initial conditions are supposed to be a {@link ScalarSet} 
     * defined as follows: column number, and for each basin: <br>
     * basin id, initial discharge, baseflow, non saturated water storage,
     * saturated water storage.
     * </p>
     * 
     */
    private ILink boundaryInputLink = null;
    private ILink boundaryOutputLink = null;

    private IInputExchangeItem hillslopeInputEI = null;
    private IInputExchangeItem rainfallInputEI = null;
    private IInputExchangeItem vegetationInputEI = null;
    private IInputExchangeItem netpfafInputEI = null;
    private IInputExchangeItem hydrometersDataInputEI = null;
    private IInputExchangeItem hydrometersFeaturesInputEI = null;
    private IInputExchangeItem boundaryInputEI = null;
    private IInputExchangeItem damsFeaturesInputEI = null;
    private IInputExchangeItem damsOverflowDischargeInputEI = null;
    private IInputExchangeItem tributaryFeaturesInputEI = null;
    private IInputExchangeItem tributaryDischargeInputEI = null;
    private IInputExchangeItem offtakesFeaturesInputEI = null;
    private IInputExchangeItem offtakesDischargeInputEI = null;

    private IOutputExchangeItem boundaryOutputEI = null;
    private IOutputExchangeItem dischargeOutputEI = null;
    private IOutputExchangeItem s1OutputEI = null;
    private IOutputExchangeItem s2OutputEI = null;
    private IOutputExchangeItem s3OutputEI = null;
    private IOutputExchangeItem basinrainOutputEI = null;

    private FeatureCollection<SimpleFeatureType, SimpleFeature> hydrometersFeatureCollection;
    private FeatureCollection<SimpleFeatureType, SimpleFeature> damsFeatureCollection;
    private FeatureCollection<SimpleFeatureType, SimpleFeature> tributaryFeatureCollection;
    private FeatureCollection<SimpleFeatureType, SimpleFeature> offtakesFeatureCollection;
    ...
    private int routingType = 3;
    private double rainIntensity = -1;
    private double rainDurationInMinutes = -1;
    private String netNumAttributeName;
    private String monPointIdAttributeName;
    private String pfaffAttributeName;
    private String baricenterAttributeName;
    private String startNetElevAttributeName;
    private String endNetElevAttributeName;
    private String vegetationAttributeName;
    private String[] outPfafIdsStrings = null;
    ...
    private ScalarSet hydrometerScalarSet;
    ...
    private ScalarSet damsQScalarSet;
    ...
    private ScalarSet tributaryQScalarSet;
    ...
    private ScalarSet offtakesQScalarSet;
    ...
    public h_adige( PrintStream output, PrintStream error ) {
        super();
    ...
    public void safeInitialize( IArgument[] properties ) throws Exception {
        ...
        for( IArgument argument : properties ) {
            ...
            if (key.equals(OUTPUTPFAFSTETTER)) {
                outPfafIdsStrings = argument.getValue().split(",");
            }
            if (key.equals(MONPOINTIDATTR)) {
                monPointIdAttributeName = argument.getValue();
            }
            if (key.equals(PFAFATTR)) {
                pfaffAttributeName = argument.getValue();
            }
            if (key.equals(BARICENTERATTR)) {
                baricenterAttributeName = argument.getValue();
            }
            if (key.equals(STARTELEVATTR)) {
                startNetElevAttributeName = argument.getValue();
            }
            if (key.equals(ENDELEVATTR)) {
                endNetElevAttributeName = argument.getValue();
            }
            if (key.equals(VEGETATION)) {
                vegetationAttributeName = argument.getValue();
            }
            if (key.equals(ROUTING)) {
                try {
                    routingType = Integer.parseInt(argument.getValue());
                } catch (Exception e) {
                }
            }
            if (key.equals(RAININTENSITY)) {
                try {
                    rainIntensity = Double.parseDouble(argument.getValue());
                } catch (Exception e) {
                }
            }
            if (key.equals(RAINDURATION)) {
                try {
                    rainDurationInMinutes = Double.parseDouble(argument.getValue());
                } catch (Exception e) {
                }
            }
            if (key.equals(LOG)) {
                try {
                    doLog = Boolean.parseBoolean(argument.getValue());
                } catch (Exception e) {
                }
            }
            ...
            if (key.equals(params_avg_sub)) {
                PARAMS_AVG_SUB = argument.getValue();
            }
            if (key.equals(params_var_sub)) {
                PARAMS_VAR_SUB = argument.getValue();
            }
            if (key.equals(params_avg_sup_10)) {
                PARAMS_AVG_SUP_10 = argument.getValue();
            }
            if (key.equals(params_var_sup_10)) {
                PARAMS_VAR_SUP_10 = argument.getValue();
            }
            if (key.equals(params_avg_sup_30)) {
                PARAMS_AVG_SUP_30 = argument.getValue();
            }
            if (key.equals(params_var_sup_30)) {
                PARAMS_VAR_SUP_30 = argument.getValue();
            }
            if (key.equals(params_avg_sup_60)) {
                PARAMS_AVG_SUP_60 = argument.getValue();
            }
            if (key.equals(params_var_sup_60)) {
                PARAMS_VAR_SUP_60 = argument.getValue();
            }
            if (key.equals(params_v_sup)) {
                PARAMS_V_SUP = argument.getValue();
            }
            if (key.equals(params_v_sub)) {
                PARAMS_V_SUB = argument.getValue();
            }
        }

        if (PARAMS_AVG_SUB == null || PARAMS_VAR_SUB == null || PARAMS_AVG_SUP_10 == null
                || PARAMS_VAR_SUP_10 == null || PARAMS_AVG_SUP_30 == null
                || PARAMS_VAR_SUP_30 == null || PARAMS_AVG_SUP_60 == null
                || PARAMS_VAR_SUP_60 == null || PARAMS_V_SUP == null || PARAMS_V_SUB == null) {
            throw new ModelsIllegalargumentException(
                    "The model was launched without the needed parameters. Check your syntax.",
                    this);

        }

        if (startDateArg == null || endDateArg == null || deltaTArg == null) {
            throw new ModelsIllegalargumentException(
        ...
        if (currentTime == null || !(tmpTime.compareTo(currentTime) == 0)) {
            ...
            if (hydrometersFeaturesInputLink != null && hydrometersDataInputLink != null) {
                if (hydrometersHandler == null) {
                    ...
                    FeatureIterator<SimpleFeature> hydrometersIterator = hydrometersFeatureCollection.features();
                    int pfaffIndex = -1;
                    int monIdIndex = -1;
            ...
            if (tributaryFeaturesInputLink != null) {
                if (tributaryHandler == null) {
                    ...
                    FeatureIterator<SimpleFeature> tributaryIterator = tributaryFeatureCollection.features();
                    int pfaffIndex = -1;
                    int monIdIndex = -1;
            ...
            if (offtakesFeaturesInputLink != null) {
                if (offtakesHandler == null) {
                    ...
                    FeatureIterator<SimpleFeature> offtakesIterator = offtakesFeatureCollection.features();
                    int pfaffIndex = -1;
                    int monIdIndex = -1;
...
//                                + " non e' stata trovata una corrispondenza tra rete e bacini.");
            ...
            if (outPfafIdsStrings != null) {
                ...
                for( int index : indexesArray ) {
                    ...
                    System.out.println("Bacino: " + outPfafIdsStrings[pfafindex]
                            ...
                            + initialConditions[index + 3 * hillsSlopeNum] + " rain " + rainArray[index]);
                    pfafindex++;
                }
            } else {
                ret.add(4.0);
    ...
    private HashMap<Integer, Double> fillParameters( HillSlope hillSlope ) {
        ...
        //Double attribute = (Double) hillSlope.getHillslopeFeature().getAttribute(PARAMS_AVG_SUP_10);
        Double attribute = ((Number)
                hillSlope.getHillslopeFeature().getAttribute(PARAMS_AVG_SUP_10)).doubleValue();
        ...
        //attribute = (Double) hillSlope.getHillslopeFeature().getAttribute(PARAMS_AVG_SUP_30);
         attribute = ((Number)
                hillSlope.getHillslopeFeature().getAttribute(PARAMS_AVG_SUP_30)).doubleValue();
        ...
        //attribute = (Double) hillSlope.getHillslopeFeature().getAttribute(PARAMS_AVG_SUP_60);
         attribute = ((Number)
                hillSlope.getHillslopeFeature().getAttribute(PARAMS_AVG_SUP_60)).doubleValue();
        ...
        //attribute = (Double) hillSlope.getHillslopeFeature().getAttribute(PARAMS_VAR_SUP_10);
         attribute = ((Number)
                hillSlope.getHillslopeFeature().getAttribute(PARAMS_VAR_SUP_10)).doubleValue();      
        ...
        attribute = ((Number)
                hillSlope.getHillslopeFeature().getAttribute(PARAMS_VAR_SUP_30)).doubleValue(); 
        ...
        attribute = ((Number)
                hillSlope.getHillslopeFeature().getAttribute(PARAMS_VAR_SUP_60)).doubleValue(); 
        ...
        attribute = ((Number)
                hillSlope.getHillslopeFeature().getAttribute(PARAMS_AVG_SUB)).doubleValue(); 
        ...
        attribute = ((Number)
                hillSlope.getHillslopeFeature().getAttribute(PARAMS_VAR_SUB)).doubleValue(); 
