...
public class Section implements Comparable<Section> {
    ...
    public Section(int id, double progressiveAlongReach, int startNode, int endNode,
            List<Double> sectionX, List<Double> sectionY, List<Double> stricklerCoeff ) {
        this.id = id;
