...
/**
 * Is the factory for the Aspect operation.
 * 
 ...
 *@FlowRIF
 */
public class HMAspectRIF implements RenderedImageFactory {
    ...
    public RenderedImage create( ParameterBlock paramBlock, RenderingHints hints ) {
        ...
        return new HMAspectOpImage(source1, borderExtender, hints, layout, dx, dy, doTile, err, out);
    }
