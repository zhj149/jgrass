...
public abstract class MapReader {
    ...
    protected JGrassRegion fileWindow = null;

    protected JGrassRegion dataWindow = null;
     ...
     */
    public JGrassRegion getMapWindow() {
        return new JGrassRegion(fileWindow);
    }
    ...
    public JGrassRegion getDataWindow() {
        return new JGrassRegion(dataWindow);
    }
     ...
     * @throws Exception 
     */
    public abstract boolean hasMoreData( IProgressMonitorJGrass monitor ) throws Exception;
     ...
     * @throws IOException 
     */
    public abstract ColorMapBuffer getNextDataColor( int attIndex ) throws IOException;
