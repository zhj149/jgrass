...
public final class GrassBinaryImageMetadata extends IIOMetadata {
     ...
     * <p>
     * As default set to {@link JGrassConstants#doubleNovalue}
     * </p>
     */
    private double noData = JGrassConstants.doubleNovalue;

    /**
     * the size of a single cell of the raster grid along X.
     */
    private double xRes = JGrassConstants.doubleNovalue;

    /**
     * the size of a single cell of the raster grid along Y.
     */
    private double yRes = JGrassConstants.doubleNovalue;
