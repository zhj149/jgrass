...
public class GrassCoverageReader {
     ...
     * @param monitor
     *            a {@link IProgressMonitorJGrass monitor} for logging purposes.
     *            This can be null, in which case a dummy one will be used.
     */
    public GrassCoverageReader( PixelInCell cellAnchor, Interpolation interpolation, boolean useSubSamplingAsColsRows,
            boolean castDoubleToFloating, IProgressMonitorJGrass monitor ) {
    ...
    private void printImage( GridCoverage2D coverage2D ) {
        ...
        RectIter iter = RectIterFactory.create(renderedImage, new Rectangle(0, 0, renderedImage.getWidth(), renderedImage
                .getHeight()));
    ...
    public static void main( String[] args ) {
        try {
            ...
            GrassCoverageReader tmp = new GrassCoverageReader(PixelInCell.CELL_CENTER, interpolation, true, false,
            ...
            JGrassRegion readRegion = new JGrassRegion(1640650.0, 1640950.0, 5139780.0, 5140020.0, 60.0, 60.0);
            ...
            GridCoverage2D interpolated = (GridCoverage2D) Operations.DEFAULT.interpolate(coverage2D, interpolation);
             ...
             */
            tmp = new GrassCoverageReader(null, null, false, false, new PrintStreamProgressMonitor(System.out));
            tmp.setInput(new File(mapPath));
