 ...
 */
package eu.hydrologis.jgrass.libs.iodrivers;
...
public class JGrassMapEnvironment {
    ...
    public double[] getRangeFromMapScan() throws IOException {
        ...
        cell_miscRangeStream.write(FileUtilities.double2bytearray(dataRange[0]));
        cell_miscRangeStream.write(FileUtilities.double2bytearray(dataRange[1]));
