...
import eu.hydrologis.jgrass.libs.io.MapReader;
import eu.hydrologis.jgrass.libs.io.RasterReadingFailureException;
...
public class JGrassRasterMapReader {
     ...
     * <li>the raster map type to read (ex. {@link JGrassConstants#GRASSBINARYRASTERMAP})</li>
    ...
    public static class BuilderFromMapPath {
        ...
        private final JGrassRegion readWindow;
        // optional parameters
        private double novalue = JGrassConstants.doubleNovalue;
         ...
         */
        public BuilderFromMapPath( JGrassRegion readWindow, String mapPath ) {
         ...
         * @return the builder object to allow chaining.
         */
        public BuilderFromMapPath monitor( IProgressMonitorJGrass monitor ) {
    ...
    public static class BuilderFromPathAndNames {
        // required parameters
        private JGrassRegion readWindow = null;
         ...
         * @param resource the {@link IGeoResource}.
         */
        public BuilderFromPathAndNames( JGrassRegion readWindow, String mapName, String mapsetName,
                String locationPath ) {
            this.readWindow = readWindow;
         ...
         * @return the builder object to allow chaining.
         */
        public BuilderFromPathAndNames monitor( IProgressMonitorJGrass monitor ) {
            this.monitor = monitor;
            return this;
        }
    ...
    private IProgressMonitorJGrass monitor = null;
    private String mapName = null;
    private String mapsetName = null;
    private String locationPath = null;
    ...
    private JGrassRasterMapReader( BuilderFromPathAndNames builder ) {
        ...
        reader = MapIOFactory.CreateRasterMapReader(builder.maptype);
        reader.setParameter("novalue", builder.novalue);
    ...
    public boolean hasMoreData() throws IOException {
        try {
            ...
            JGrassLibsPlugin
                    .log(
                            "JGrassLibsPlugin problem: eu.hydrologis.jgrass.libs.map#JGrassRasterMapReader#hasMoreData", e); //$NON-NLS-1$
            e.printStackTrace();
