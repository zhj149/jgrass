 ...
 */
public class DwgImportWizardPage extends WizardPage {

    public static final String ID = "DwgImportWizardPage"; //$NON-NLS-1$
    ...
    public DwgImportWizardPage( String pageName, Map<String, String> params ) {
        super(ID);
        setTitle(pageName);
        setDescription("Import the selected dwg file"); // NON-NLS-1
        // //$NON-NLS-1$
    }
    ...
    public void createControl( Composite parent ) {
        ...
        inputGroup.setText("Choose the DWG file");
    ...
    private void checkFinish() {
        if (inIsOk && epsgIsOk) {
            DwgImportWizard.canFinish = true;
        }else{
            DwgImportWizard.canFinish = false;
        }
